...
class TestDatabaseInitialization:
    ...
    def test_index_table_exists(self, clean_db):
        ...
        expected_columns = {"hash", "file", "purpose", "created", "modified", "storage", "important"}
...
class TestFileOperations:
    ...
    def test_add_file_success(self, clean_db):
        ...
        assert len(file_hash) == 64, f"Hash should be 64 chars (SHA256), got {len(file_hash)}"
...
class TestEnvironmentIntegration:
    ...
    def test_multiple_files_integration(self, clean_db, test_env_path, test_config_file):
